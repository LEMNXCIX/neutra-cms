...
export interface ApiAdminTenantAdminTenant extends Struct.CollectionTypeSchema {
  collectionName: 'admin_tenants';
  info: {
    description: 'Maps an admin-panel user (by email) to a tenant. Admins not listed here are superadmins (full access).';
    displayName: 'Tenant Admin';
    pluralName: 'admin-tenants';
    singularName: 'admin-tenant';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tenantId: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomeContentHomeContent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Marketing copy for a tenant storefront home';
  ...
  attributes: {
    ...
    ctaHighlight: Schema.Attribute.String;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static pages (about, faq, contact, privacy, terms, careers) per tenant';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['shared.rich-text', 'shared.faq-item']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::admin-tenant.admin-tenant': ApiAdminTenantAdminTenant;
